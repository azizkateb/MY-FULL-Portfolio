...
const projects = [
  ...
  {
    title: "Launch AI",
    description: "This is an AI-powered tool that generates landings pages for startups. It uses the Qroq API to generate content and images based on user input. The tool is built with React and tailwindcss, and it features a sleek design and user-friendly interface.",
    tech: ["React", "OpenAI API", "API Integration", "tailwindcss"],
  ...
  },
  {
    ...
    description: "This is a travel agency website built with React and JavaScript, showcasing various travel packages and destinations. It features a modern design and smooth animations.",
  ...
  {
    title: "IYED AUTO WASH",
    description: "This is a car wash business website built with React and JavaScript, showcasing various services and promotions. It features a modern design and smooth animations.",
    tech: ["React", "javascript", "tailwindcss"],
